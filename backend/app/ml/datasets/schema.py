...
class DatasetProvenance(BaseModel):
    ...
    citation: str | None = Field(default=None, description="Academic DOI or publication citation")
    ...
    checksum_manifest: str | None = Field(default=None, description="SHA256 checksum of raw dataset archive")
...
class DatasetSample(BaseModel):
    ...
    athlete_id: str | None = Field(
        default=None,
        description=(
            "De-identified athlete/subject ID (e.g. 'CALGARY_SUBJ_0042') for group-level data leakage prevention"
        ),
    )
    ...
    video_path: str | None = Field(
        default=None,
        description=(
            "Relative or absolute path to video file if modality is VIDEO or MULTIMODAL. "
            "None for motion capture/tabular."
        ),
    )
    ...
    injury_label: int | float | str | None = Field(
        default=None,
    ...
    injury_type: str | None = Field(
        default=None,
        description=(
            "Specific injury classification (e.g., 'PATELLOFEMORAL_PAIN', 'IT_BAND_SYNDROME', 'HEALTHY_CONTROL')"
        ),
    )
    ...
    timestamp_onset_seconds: float | None = Field(
        default=None,
    ...
    checksum_sha256: str | None = Field(default=None, description="SHA256 checksum of raw source file")
