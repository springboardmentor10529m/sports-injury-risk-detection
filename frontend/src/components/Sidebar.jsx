...
const navigationByRole = {
  ...
  [ROLES.ADMIN]: [['Dashboard', '/admin/dashboard', '▦'], ['Organization Overview', '/admin/overview', '⌂'], ['Athletes', '/admin/athletes', '♟'], ['Coaches', '/admin/coaches', '♞'], ['Physiotherapists', '/admin/physiotherapists', '⚕'], ['Teams / Groups', '/admin/teams', '◫'], ['Access & Permissions', '/admin/access-permissions', '⚿'], ['Organization Analytics', '/admin/analytics', '📊'], ['Reports', '/admin/reports', '▤'], ['Organization Settings', '/admin/organization-settings', '⚙']],
}
